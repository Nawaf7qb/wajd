// تعريف المتغيرات
let wordsLevel1 = [
    "قَمَر", "بَاب", "سَمَك", "شَجَر", "بَحْر", "جَبَل", "كِتَاب", "قَلَم", "وَرْد", "نَهْر",
    "بَيْت", "حِصَان", "سَاعَة", "شَمْس", "قِطّ", "عُصْفُور", "زَهْرَة", "كُرَة", "سَيَّارَة", "طَائِرَة",
    "قِطْعَة", "صُورَة", "مِفْتَاح", "سُلَّم", "كُوب", "صَحْن", "سَرِير", "مِصْبَاح", "حَقِيبَة", "نَجْمَة",
    "عَيْن", "أُذُن", "فَم", "يَد", "رِجْل", "رَأْس", "شَعْر", "أَسَد", "فِيل", "ذِئْب",
    "غَزَال", "دُبّ", "قِرْد", "حَمَام", "بَطَّة", "فَأْر", "عَنْكَبُوت", "نَحْلَة", "فَرَاشَة", "سُلَحْفَاة",
    "سِكِّين", "زِرّ", "سَجَّاد", "زُجَاج", "سِلْسِلَة", "زُبْد", "سُرْعَة", "زَهْر", "سِكَّة", "زَمَان"
];
...
let wordsLevel2 = [
    ...
    "مِسْطَرَة", "مِسْوَدَّة", "مِسْوَدَّة", "مِسْوَدَّة", "mِسْوَدَّة", "مِسْوَدَّة", "مِسْوَدَّة", "مِسْوَدَّة", "مِسْوَدَّة", "مِسْوَدَّة",
    "سِكِّين", "زِرّ", "سَجَّاد", "زُجَاج", "سِلْسِلَة", "زُبْد", "سُرْعَة", "زَهْر", "سِكَّة", "زَمَان"
];
...
async function startRecordingAndAnalysis() {
    ...
    try {
        ...
        await new Promise(resolve => setTimeout(resolve, 1500)); // تأخير 1500 مللي ثانية (1.5 ثانية)
